...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    public Question addQuestion(Question question) throws QuizException {
        try{
            questionRepository.save(question);
        } catch (Exception e){
            logger.error("Exception in addQuestion(): ", e);
            throw new QuizException("Exception in saving question");
        }
        return question;
//        return this.questionRepository.save(question);
    ...
    @Override
    public Question updateQuestion(Question question) throws QuizException {
        try{
            questionRepository.save(question);
        } catch (Exception e){
            logger.error("Exception in updateQuestion(): ", e);
            throw new QuizException("Exception in updating question");
        }
        return question;
//        return this.questionRepository.save(question);
    }
